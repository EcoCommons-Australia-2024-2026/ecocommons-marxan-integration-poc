...
2.  Species distribution modelling output: **Probability maps**.

## **Marxan MaPP Inputs**

1.  Shapefile of planning area and units.
2.  Shapefile of cost.
3.  Shapefile and csv of biodiversity features.
...
setwd("/Users/zhaoxiang/Documents/QCIF_doc/QLD_Koala_Marxan")
...
plot(koala, ext = extent_QLD, main = "Koala\nSDM")  # Wrap title with a newline character
...
![](images/Screenshot 2024-09-07 at 9.36.12 PM.png)

Scenario 1: No SDMs, No Costs

![](images/clipboard-1794983472.png)

Scenario 2: SDMS, No Costs

![](images/clipboard-1683320824.png)

Scenario 3: Costs, No SDMs

![](images/clipboard-1642299349.png)

Scenario 4: SDMs + Costs

![](images/clipboard-3046106326.png)
